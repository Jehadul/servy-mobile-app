...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final RadioGroup rg = (RadioGroup) findViewById(R.id.radio_group_appType);
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                switch(checkedId){
                    case R.id.radio_bank:
                        ...
                        nbfiSection.setVisibility(LinearLayout.GONE);
                        customerSection.setVisibility(LinearLayout.GONE);
                        new JsonTask().execute("http://10.44.20.132:8080/srvm/v1/getList?type=BRBANK");
                        break;
                    case R.id.radio_nbfi:
                        bankSection.setVisibility(LinearLayout.GONE);
                        nbfiSection.setVisibility(LinearLayout.VISIBLE);
                        customerSection.setVisibility(LinearLayout.GONE);
                        new JsonTask().execute("http://10.44.20.132:8080/srvm/v1/getList?type=BRNBFI");
                        break;
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String radioItem = radioButton.getText().toString();
    ...
    private void insert(String s, String s1, String radioItem) {
        String type = "insert";
        BackWork worker = new BackWork(MainActivity.this);
        worker.execute(type, s, s1, radioItem);
    }
